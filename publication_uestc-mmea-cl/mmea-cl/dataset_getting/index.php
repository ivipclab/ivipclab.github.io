...
<font size = "8">UESTC-MMEA-CL</font>
</p><br/>  
Thank you for your interest in our UESTC-MMEA-CLdata!By requesting access to the multimodal dataset,
...
2. If the user wishs to use UESTC-MMEA-CL for
...
4. If the user uses UESTC-MMEA-CL in his
research, please cite the reference in this publications.5. The user will not redistribute UESTC-MMEA-CL or
its derivatives, unless given specific and prior approval from the authors.Please provide the following information for
requesting access to our UESTC-MMEA-CL dataset.
</p><br/>
